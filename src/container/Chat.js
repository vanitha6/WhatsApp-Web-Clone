...
import ReceivedMsg from './UtilityComponenets/ReceivedMsg';
import Message from './UtilityComponenets/Message';
    ...
    <div className="chat">
      <div className="chat__header">
        ...
        <div className="chat__headerInfo">
          <h3>{roomName}</h3>
          <p>Last seen  {messages[0] && timeFromNow(messages[messages.length - 1]?.data?.timestamp)}</p>
        </div>
